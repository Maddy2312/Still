      ...
      <div className="max-w-[1400px] mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex-1 flex items-center justify-end gap-6">
          ...
          {!user ? (
            ...
            <div className="flex items-center gap-6">
              <Link to="/cart" className="hidden sm:flex text-xs uppercase tracking-[0.2em] font-medium text-stone-900 dark:text-stone-100 hover:text-stone-500 dark:hover:text-stone-400 transition-colors items-center gap-2">
                <span>Bag</span>
              </Link>
              <button onClick={handleLogout} className="text-xs uppercase tracking-[0.2em] font-medium text-stone-500 hover:text-stone-900 dark:hover:text-stone-100 transition-colors">
                Logout
