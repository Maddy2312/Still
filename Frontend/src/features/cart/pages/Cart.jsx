...
const Cart = () => {
  ...
  const handleCheckout = async () => {
    try {
      ...
      const options = {
        key: "rzp_test_SzttrpbKBuxAIQ", // Replace with your Razorpay key_id
              ...
              <div className="lg:col-span-7 flex flex-col">
                {items.map((item, idx) => {
                  ...
                  return (
                    <div
                      key={item._id}
                      className={`flex gap-6 py-8 ${idx < items.length - 1 ? "border-b border-stone-800" : ""}`}
                    >
                      {/* Image */}
                      <div
                        ...
                        <div className="flex justify-between items-end mt-4">
                          ...
                          <div className="flex items-center border border-stone-800 hover:border-stone-600 transition-colors">
                            ...
                            <button
                              onClick={() => {
                                const stock =
                                  item.product?.variants?.stock || 99;
                ...
                <div className="border border-stone-800 p-8 md:p-10 sticky top-28 bg-[#0f0e0b]">
                  ...
                  <div className="space-y-5 mb-8">
                    {[
                      {
                        label: "Subtotal",
                        value: `${currencySymbol}${totalPrice.toFixed(2)}`,
                      },
                      ...
                      <div
                        key={i}
                        className="flex justify-between border-b border-stone-800 pb-5"
                      >
                        <span className="font-sans-luxury text-[9px] tracking-widest uppercase text-stone-600">
                          {row.label}
                        </span>
                        <span className="font-sans-luxury text-xs text-stone-300">
                          {row.value}
                        </span>
                      </div>
                    ))}
                  ...
                  <button
                    ...
                    className="font-sans-luxury w-full border border-stone-700 hover:border-stone-300 text-stone-300 hover:text-white text-[9px] tracking-[0.5em] uppercase py-5 transition-all duration-300 hover:bg-stone-800/20 mb-4"
                  >
                    Proceed to Checkout
                  </button>
                  ...
                  <div className="mt-10 pt-8 border-t border-stone-800 space-y-3">
                    {[
                      ...
                      <p
                        key={i}
                        className="font-sans-luxury text-[9px] tracking-widest uppercase text-stone-600 flex items-center gap-3"
                      >
